      ...
      <div className="section-container relative z-10 opacity-0 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto glass-card p-6 sm:p-8 md:p-10 lg:p-14 text-center overflow-hidden relative">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
            ...
            <span className="text-pulse-500">The Future of Ticketing?</span>
          </h2>
          
          <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto">
            Join thousands of event-goers who have already embraced NFT tickets. Secure, transparent, and truly yours.
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="/app" className="button-primary group flex items-center justify-center w-full sm:w-auto">
              Launch App
              <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
            </a>
            <a href="/app/browse" className="button-secondary w-full sm:w-auto text-center">
              Browse Events
            </a>
          </div>
        </div>
